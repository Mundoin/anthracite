# 001-accepted-lldp-single-edge

Purpose: prep-only corpus for V1AS topology edge review and graph-ready surface behaviour.

Scenario: One LLDP-backed projected edge is accepted and selected.
...
- One accepted LLDP-backed edge keeps the review table, inspector, and drilldown aligned.
