# 012-missing-remote-interface

Purpose: prep-only corpus for V1AS topology edge review and graph-ready surface behaviour.

Scenario: The evidence lacks a remote interface, so exact projection stays unsafe.
...
- Missing remote interface stays visible as a rejection case.
