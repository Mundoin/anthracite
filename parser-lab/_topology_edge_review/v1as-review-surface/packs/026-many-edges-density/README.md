# 026-many-edges-density

Purpose: prep-only corpus for V1AS topology edge review and graph-ready surface behaviour.

Scenario: A dense table shows many edges without losing stable sort or grouping.
...
- High-density lists remain readable and deterministic.
