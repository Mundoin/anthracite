# 008-rejected-self-link

Purpose: prep-only corpus for V1AS topology edge review and graph-ready surface behaviour.

Scenario: Local and remote identities collapse to the same node, so the edge is rejected.
...
- Self-link rejection stays visible and honest.
