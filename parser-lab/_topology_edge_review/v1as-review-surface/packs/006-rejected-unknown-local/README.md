# 006-rejected-unknown-local

Purpose: prep-only corpus for V1AS topology edge review and graph-ready surface behaviour.

Scenario: The resolver cannot match the local node, so nothing is promoted.
...
- Unknown local node rejection stays visible and honest.
