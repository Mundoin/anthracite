# 002-accepted-cdp-single-edge

Purpose: prep-only corpus for V1AS topology edge review and graph-ready surface behaviour.

Scenario: One CDP-backed projected edge is accepted and selected.
...
- One accepted CDP-backed edge keeps the review table, inspector, and drilldown aligned.
