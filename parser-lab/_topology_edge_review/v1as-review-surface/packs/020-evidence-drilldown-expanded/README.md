# 020-evidence-drilldown-expanded

Purpose: prep-only corpus for V1AS topology edge review and graph-ready surface behaviour.

Scenario: The evidence drilldown expands to show accepted, rejected, conflict, and stale rows.
...
- Expanded evidence drilldown stays honest and complete.
