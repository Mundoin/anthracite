# 018-interface-search-filter

Purpose: prep-only corpus for V1AS topology edge review and graph-ready surface behaviour.

Scenario: Interface search narrows the table by exact interface identity.
...
- Interface search remains exact and rejects fuzzy behaviour.
