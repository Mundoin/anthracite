# 029-stale-evidence-labelled-not-promoted

Purpose: prep-only corpus for V1AS topology edge review and graph-ready surface behaviour.

Scenario: Stale evidence is labelled and kept out of current projection.
...
- Stale evidence remains labelled and not promoted.
