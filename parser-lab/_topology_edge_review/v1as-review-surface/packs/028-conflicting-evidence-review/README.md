# 028-conflicting-evidence-review

Purpose: prep-only corpus for V1AS topology edge review and graph-ready surface behaviour.

Scenario: Conflicting evidence stays visible beside the selected edge.
...
- Conflicting evidence remains honest and inspectable.
