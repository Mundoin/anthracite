# 003-duplicate-reverse-edge

Purpose: prep-only corpus for V1AS topology edge review and graph-ready surface behaviour.

Scenario: Reverse-direction evidence collapses into one current edge.
...
- Reverse-direction evidence collapses while remaining visible in drilldown.
