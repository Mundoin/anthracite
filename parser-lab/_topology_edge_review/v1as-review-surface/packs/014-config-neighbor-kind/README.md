# 014-config-neighbor-kind

Purpose: prep-only corpus for V1AS topology edge review and graph-ready surface behaviour.

Scenario: Config-neighbour evidence is present and can be filtered exactly.
...
- Config-neighbour evidence appears as a filterable source kind.
