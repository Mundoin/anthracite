# 004-merge-labels-and-notes

Purpose: prep-only corpus for V1AS topology edge review and graph-ready surface behaviour.

Scenario: Evidence labels and notes merge onto one projected edge.
...
- Merged labels and notes stay visible without changing the edge identity.
