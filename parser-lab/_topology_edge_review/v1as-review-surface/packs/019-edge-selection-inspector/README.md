# 019-edge-selection-inspector

Purpose: prep-only corpus for V1AS topology edge review and graph-ready surface behaviour.

Scenario: A selected edge stays visible in the inspector with its evidence.
...
- The selected-edge inspector remains readable and stable.
