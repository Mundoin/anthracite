# live-collection-eos-lldp-cdp-012 intent

This pack prepares OCC for eos lldp/cdp live output in V1AT.
It stays prep-only, synthetic, and sanitised.

## Pack focus
- Show EOS LLDP as the strong source and CDP as a conservative source.
...
## LLDP detail
- OCC may later use this section to keep eos lldp/cdp live output read-only and review-gated.
