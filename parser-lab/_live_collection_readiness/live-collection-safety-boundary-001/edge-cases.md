# live-collection-safety-boundary-001 edge cases
...
## Pack-specific risks
- A preview can look safe while still being wrong for the target device.
- No store mutation should happen until review completes.
