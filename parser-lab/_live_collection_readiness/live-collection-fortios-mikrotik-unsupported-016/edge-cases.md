# live-collection-fortios-mikrotik-unsupported-016 edge cases
...
## Pack-specific risks
- A lower-confidence source should never be promoted to a strong topology fact without review.
