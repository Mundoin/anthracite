# live-collection-platform-command-map-009 intent

This pack prepares OCC for platform command map in V1AT.
It stays prep-only, synthetic, and sanitised.

## Pack focus
- Map vendor platforms to the read-only commands that are safe to preview later.
...
## Command map
- OCC may later use this section to keep platform command map read-only and review-gated.
