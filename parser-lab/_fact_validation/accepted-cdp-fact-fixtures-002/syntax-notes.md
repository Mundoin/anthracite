# Accepted CDP syntax notes

These notes describe the evidence shapes represented in the snippet pack.

## IOS-XE

- `snippets/accepted-cdp-fact-fixtures-002.txt / accepted-cdp-iosxe-001`
- Observed patterns:
...
- `snippets/accepted-cdp-fact-fixtures-002.txt / accepted-cdp-nxos-002`
- Observed patterns:
  - `show cdp neighbors detail`
  - `Device ID`
  - `Local Port`
