...
// Anthracite — Hardware Model Kit · firewall builders
//
...
function buildFirewallModels(scene: any, mats: any, opts: any = {}) {
  const profiles = window.AnthraciteProfiles.FirewallProfiles;
