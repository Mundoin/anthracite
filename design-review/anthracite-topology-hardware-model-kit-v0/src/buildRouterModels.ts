...
// Anthracite — Hardware Model Kit · router builders
//
...
function buildRouterModels(scene: any, mats: any, opts: any = {}) {
  const profiles = window.AnthraciteProfiles.RouterProfiles;
