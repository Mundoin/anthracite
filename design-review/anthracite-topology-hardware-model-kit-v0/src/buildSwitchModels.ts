...
// Anthracite — Hardware Model Kit · switch builders
//
...
function buildSwitchModels(scene: any, mats: any, opts: any = {}) {
  const profiles = window.AnthraciteProfiles.SwitchProfiles;
