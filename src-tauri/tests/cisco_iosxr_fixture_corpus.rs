//! Cisco IOS XR fixture corpus harness.
...
const FIXTURE_ROOT: &str = "tests/fixtures/cisco-iosxr";
...
fn platform_ref() -> PlatformRef {
    PlatformRef {
        ...
        os_family: Some("IOS XR".to_string()),
        os_version_raw: None,
...
fn manifest_parser_version_matches_source() {
    let m = read_manifest();
    assert_eq!(m.parser_version, anthracite_lib::engines::parsers::cisco_iosxr::PARSER_VERSION);
}
