//! Aruba AOS-CX fixture corpus harness.
...
const FIXTURE_ROOT: &str = "tests/fixtures/aruba-aoscx";
...
fn platform_ref() -> PlatformRef {
    PlatformRef {
        ...
        vendor: Some("HPE Aruba".to_string()),
        os_family: Some("AOS-CX / ArubaOS".to_string()),
        os_version_raw: None,
...
fn manifest_parser_version_matches_source() {
    let m = read_manifest();
    assert_eq!(m.parser_version, anthracite_lib::engines::parsers::aruba_aoscx::PARSER_VERSION);
}
