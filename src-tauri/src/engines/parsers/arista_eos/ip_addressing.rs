//! EOS IP addressing — V1N.
//!
//! EOS accepts both `ip address 10.0.0.1/24` slash form and the legacy
//! `ip address 10.0.0.1 255.255.255.0` dotted-mask form. V1N parses
//! both; output is always the canonical numeric prefix length.
